...
Write-Host
Write-Host "In $($local):"
Write-Host "Expect bookmarks 'hobbit' and 'hobbit@default' (divergence)" -ForegroundColor Green
Write-Host "Expect 2 incoming/1 outgoing changesets on bookmark 'hobbit'" -ForegroundColor Green
